...
// Part of this file contains code from other projects. Attribution is below.
...
unsigned int static NeutrinoGravityWave_V1(const CBlockIndex* pindexLast, const CBlockHeader *pblock) {
